	...
	<div class="container">
		...
		<div class="col-xs-12">
			...
			{{-- <ul>
				...
				<li>IVF:&nbsp;@foreach($data4Results as $data){{ $data }}
				@endforeach</li>
				<li>Meds:
				@foreach($data5Results as $data){!! $data !!}
				@endforeach
			...
			<p style="padding: 0; margin: 0;">@foreach($data6Results as $data){!! $data !!}
			@endforeach</p>
			<p><strong>Refer Accordingly.</strong></p> --}}
